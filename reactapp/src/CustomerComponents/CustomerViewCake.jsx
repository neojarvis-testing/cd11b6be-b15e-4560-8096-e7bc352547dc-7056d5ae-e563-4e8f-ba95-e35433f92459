...
const CustomerViewCake = () => {
    const [cakes, setCakes] = useState([]);  // Stores cake data
    ...
    // ✅ Fetch cakes from API when component loads
    useEffect(() => {
    ...
    // ✅ Automatically filter cakes based on search input
    useEffect(() => {
        setFilteredCakes(
            cakes.filter((cake) =>
    ...
    }, [searchQuery, cakes]); // ✅ Runs when search query or cake data changes
    ...
    return (
        <>
            ...
            <div className="container mt-5">
                <h2 className="text-center mb-4">Available Cakes</h2>
